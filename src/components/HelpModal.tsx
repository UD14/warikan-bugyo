      ...
      >
        <header className="bg-indigo-600 px-6 py-5 text-white flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-black tracking-tight">「わりかん奉行」とは？</h2>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-8 text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
              <Edit3 size={20} className="text-indigo-600 mb-2" />
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
              <History size={20} className="text-indigo-600 mb-2" />
          ...
          <section className="pt-4 border-t border-gray-100">
            <div className="bg-indigo-50 rounded-2xl p-4 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-black text-indigo-900 text-sm mb-1">使いこなしのコツ</h4>
